...
TIPS = [
    ...
    "Ctrl+Z suspends Athena to the background — run fg in your shell to resume.",
    ...
    "hermes mcp serve runs Athena itself as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire Athena home directory.",
    ...
    "hermes gateway install sets up Athena as a system service (systemd/launchd).",
    ...
    # --- Tools & Capabilities ---
    "execute_code runs Python scripts that call Athena tools programmatically — results stay out of context.",
    ...
    "When exiting, Athena prints a resume command with session ID and stats.",
    ...
    # --- Gateway & Messaging ---
    "Athena runs on 18 platforms: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, email, and more.",
    ...
    "BlueBubbles brings iMessage to Athena via a local macOS server.",
    ...
    "Athena loads project context from .hermes.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "hermes acp runs Athena as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    "SOUL.md completely replaces the agent's default identity — rewrite it to make Athena your own.",
    ...
    "Before a gateway session reset, Athena auto-flushes important facts to memory in the background.",
